		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!btn1Label.getText().equals("0") || !btn2Label.getText().equals("0")
					...
					win.jpanel05.setTextBox("코카콜라	: " + btn1Label.getText() + "\n");
					win.jpanel05.setTextBox("스프라이트	: " + btn2Label.getText() + "\n");
					win.jpanel05.setTextBox("아메리카노	: " + btn3Label.getText() + "\n");
					win.jpanel05.setTextBox("핫초코  	: " + btn4Label.getText() + "\n");
				} else {
